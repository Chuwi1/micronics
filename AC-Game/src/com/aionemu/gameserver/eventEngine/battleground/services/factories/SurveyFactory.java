...
public class SurveyFactory {
    ...
    public static String buildAssaultBattleGroundReport(Player player) {
        ...
        html += "	<![CDATA[<font color='4CB1E5' size='+1'><center>Resultados del campo de batalla de asalto</center></font>]]>\n";
        html += "</poll_introduction>\n";
        html += "<poll_title>\n";
        ...
        html += "			<![CDATA[\n";
        html += "<br><br>";
        html += "<font color='" + winnerColor + "' size='+2' style='font-weight: bold;'>" + winner + " Gana !</font>";
        html += "			]]>\n";
        html += "		</title>\n";
        html += "		<select>\n";
        html += "		</select>\n";
        ...
        html += "			<![CDATA[\n";
        html += "<br><br>";
        html += "<font color='4CB1E5'><center>Elyos - Puntos: " + EPts + " - Muertes:" + EKills + "</center></font>";
        html += "<br><br>";

        html += "<table border='0'>";
        html += "<tr><td><center>Pos.</center></td><td><center>Nombre</center></td><td><center>&nbsp;Puntos&nbsp;</center></td><td><center>&nbsp;&nbsp;Muertes&nbsp;&nbsp;</center></td><td><center>&nbsp;&nbsp;Deaths&nbsp;&nbsp;</center></td>";
        int counter = 1;
        for (Player e : elyos) {
        ...
        html += "			<![CDATA[\n";
        html += "<br><br>";
        html += "<font color='ffba75'><center>Asmodians - Puntos: " + APts + " - Muertes:" + AKills + "</center></font>";
        html += "<br><br>";
        ...
        if (player.battlegroundObserve == 0) {
            ...
            html += "Has ganado " + earnedPoints + " BG points, ";

            html += "Su total de BG puntos es ahora : " + (player.getCommonData().getBattleGroundPoints() + earnedPoints) + ".<br><br>";
            ...
            for (BattleGroundTemplate template : BattleGroundManager.getUnlockedBattleGrounds(oldPoints, player.getCommonData().getBattleGroundPoints())) {
                html += "Has desbloqueado el siguiente campo de batalla : " + template.getName() + " (" + template.getJoinConditions().getRequiredBgPoints() + " pts.)<br><br>";
            }
        ...
        html += "		</title>\n";
        html += "		<select>\n";
        html += "			<input type='radio'>Cerrar</input>";
        html += "		</select>\n";
        html += "	</question>\n";
    ...
    public static String buildCTFBattleGroundReport(Player player) {
        ...
        html += "			<![CDATA[\n";
        html += "<br><br>";
        html += "<font color='4CB1E5'><center>Elyos - Banderas: " + EFlags + " - Puntos: " + EPts + "</center></font>";
        html += "<br><br>";
        ...
        html += "			<![CDATA[\n";
        html += "<br><br>";
        html += "<font color='ffba75'><center>Asmodians - Banderas: " + AFlags + " - Puntos: " + APts + "</center></font>";
        html += "<br><br>";
    ...
    public static String getBattleGroundRanking(BattleGround bg) {
        ...
        if (bg.getTemplate().getType() == BattleGroundType.CTF) {
            ...
            html += "<table border='0'>";
            html += "<tr><td><center>Pos.</center></td><td><center>Nombre</center></td><td><center>&nbsp;Puntos&nbsp;</center></td><td><center>&nbsp;&nbsp;Kills&nbsp;&nbsp;</center></td><td><center>&nbsp;&nbsp;Flags&nbsp;&nbsp;</center></td>";
            counter = 1;
            for (Player e : elyos) {
                html += "<tr><td>" + counter + ". </td><td>" + e.getName() + "&nbsp;&nbsp;</td><td>&nbsp; " + e.battlegroundSessionPoints + " &nbsp;</td><td>&nbsp; " + e.battlegroundSessionKills
                        + " &nbsp;</td><td>&nbsp; " + e.battlegroundSessionFlags + "</td></tr>";
        ...
        if (bg.getTemplate().getType() == BattleGroundType.ASSAULT) {
            html += "<font color='4CB1E5'><center>Elyos - Puntos: " + EPts + " - Kills: " + EKills + "</center></font>";
            html += "<br><br>";

            html += "<table border='0'>";
            html += "<tr><td><center>Pos.</center></td><td><center>Nombre</center></td><td><center>&nbsp;Puntos&nbsp;</center></td><td><center>&nbsp;&nbsp;Kills&nbsp;&nbsp;</center></td><td><center>&nbsp;&nbsp;Deaths&nbsp;&nbsp;</center></td>";
            counter = 1;
            for (Player e : elyos) {
                html += "<tr><td>" + counter + ". </td><td>" + e.getName() + "&nbsp;&nbsp;</td><td>&nbsp; " + e.battlegroundSessionPoints + " &nbsp;</td><td>&nbsp; " + e.battlegroundSessionKills
                        + " &nbsp;</td><td>&nbsp; " + e.battlegroundSessionDeaths + "</td></tr>";
        ...
        html += "		</title>\n";
        html += "		<select>\n";
        html += "			<input type='radio' checked='checked'>Cerrar</input>";
        html += "		</select>\n";
        html += "	</question>\n";
    ...
    public static String TeamRegistrationForm() {
        String html = "<poll>\n";
        html += "<poll_introduction>\n";
        html += "   <![CDATA[<font color='4CB1E5'>Registro de equipo para la batalla</font>]]>\n";
        html += "</poll_introduction>\n";
        html += "<poll_title>\n";
        html += "   <font color='ffc519'></font>\n";
        html += "</poll_title>\n";
        ...
        html += "<br><br>";
        html += "Elige el equipo con el que quieres pelear : ";
        html += "<br><br>";
        ...
        html += "           <input type='radio'>Registrarse con tu equipo 2v2</input>";
        html += "           <input type='radio'>Registrarse con tu equipo 3v3</input>";
        html += "           <input type='radio'>Registrarse con tu equipo 5v5</input>";
    ...
    public static String getRemovePlayerMenu() {
        ...
        html += "       <title>\n";
        html += "           <![CDATA[\n";
        html += "Estás seguro de quitar este jugador?<br><br>";
        html += "           ]]>\n";
        html += "       </title>\n";
        html += "       <select>";
        html += "       <input type='radio'>Sí, lo estoy</input>\n";
        html += "       <input type='radio'>Cancelar solicitud de eliminación</input>\n";
        html += "       </select>";
        html += "   </question>\n";
