...
public final class PlayerEnterWorldService {
    ...
    private static final String serverIntro = "Recuerde: no se permite el uso compartido de la cuenta.";
    ...
    static {
        ...
        String alBuffer = "=============================\n";
        alBuffer = alBuffer +  "Client Version: " + GSConfig.SERVER_VERSION + " .";
        alBuffer = alBuffer + "=============================\n";
